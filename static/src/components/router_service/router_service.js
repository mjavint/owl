...
export class RouterService extends Component {
  ...
  setRouteInUrl() {
    ...
    hash.view_type = "form";
    browser.location =
      browser.location.origin + routeToUrl(this.routerService.current);
  }
}

RouterService.template = "owl.routerService";
RouterService.components = { Layout };

registry.category("actions").add("owl.routerService", RouterService);
